...
export function InstallPrompt() {
  ...
  return (
    <>
      ...
      {showWechatBar && (
        <div
          className="fixed inset-x-0 top-0 z-[100] border-b px-3 py-2 text-xs shadow-sm"
          style={{ borderColor: 'var(--wb-warn-soft)', background: 'var(--wb-warn-soft)', color: 'var(--wb-warn)' }}
        >
          <div className="mx-auto flex max-w-6xl items-center gap-2">
            ...
            <button
              ...
              className="rounded px-1.5 py-0.5 transition hover:opacity-70"
              aria-label="关闭提示"
            >
              ✕
            </button>
      ...
      {showIOSModal && (
        ...
        >
          <div
            className="wb-card relative w-full max-w-sm overflow-hidden p-5"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              type="button"
              onClick={dismissIOS}
              className="absolute right-3 top-3 rounded p-1 transition hover:bg-[var(--wb-surface-2)]"
            ...
            <div className="mb-3 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: 'var(--wb-ink-2)' }}>像 App 一样使用</p>
              </div>
            </div>
            <ol className="space-y-2.5 text-sm" style={{ color: 'var(--wb-ink-2)' }}>
              <li className="flex items-start gap-2">
                ...
                <span>
                  点击底部的 <strong style={{ color: 'var(--wb-brand-500)' }}>分享按钮</strong>
            ...
            <button
              type="button"
              onClick={dismissIOS}
              className="wb-btn-primary mt-4 w-full justify-center"
            >
              我知道了
            </button>
          </div>
      ...
      {showChromeToast && deferredPrompt && (
        <div className="fixed inset-x-0 bottom-0 z-[100] p-3">
          <div className="wb-card mx-auto flex max-w-md items-center gap-3 px-4 py-3">
            ...
            <div className="flex-1 text-sm" style={{ color: 'var(--wb-ink)' }}>
              <p className="font-medium">添加到桌面</p>
              <p className="text-xs" style={{ color: 'var(--wb-ink-2)' }}>
            ...
            <button
              ...
              className="rounded p-1 transition hover:bg-[var(--wb-surface-2)]"
              style={{ color: 'var(--wb-ink-3)' }}
              aria-label="关闭"
            >
            ...
            <button type="button" onClick={installChrome} className="wb-btn-primary text-sm">
              安装
            </button>
          </div>
        </div>
        ...
        <div className="fixed inset-x-0 bottom-0 z-[100] p-3">
          <div className="wb-card mx-auto flex max-w-md items-center gap-3 px-4 py-3">
            ...
            <button
              ...
              className="rounded px-2.5 py-1 text-xs font-medium transition hover:bg-[var(--wb-surface-2)]"
